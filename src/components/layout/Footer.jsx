    ...
    <footer>
      <div className="container footer-shell">
        <div className="footer-grid editorial-footer">
          ...
          <nav aria-label="Company"><strong>GAUAS</strong><Link to="/product">Product</Link><Link to="/about">About</Link><button type="button" onClick={openContactModal}>Contact</button></nav>
          ...
          <nav aria-label="Resources"><strong>RESOURCES</strong><Link to="/product">Products</Link><Link to="/support">Support</Link></nav>
